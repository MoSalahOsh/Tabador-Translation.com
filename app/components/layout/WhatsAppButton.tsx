...
export function WhatsAppButton({ lang, whatsapp, message, dict }: Props) {
  ...
  return (
    <a
      ...
      className="float-cta group flex items-center gap-2 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2"
    ...
    >
      ...
      <span className="hidden md:block pe-4 text-sm font-semibold whitespace-nowrap overflow-hidden max-w-0 group-hover:max-w-xs transition-all duration-300">
